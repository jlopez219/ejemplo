package com.formacionbdi.microservicio.app.usuarios.controllers;
...
import com.formacionbdi.microservicio.app.usuarios.services.AlumnoService;
...
public class AlumnoController extends CommonController<Alumno,AlumnoService>{
	...
	public  ResponseEntity<?> editarConFoto(@Valid  Alumno alumno, @PathVariable Long id,
		...
		alumnoDb.setApellido(alumno.getApellido());
		alumnoDb.setEmail(alumno.getEmail());
		System.out.print("jlm:"+archivo.isEmpty());
		if (!archivo.isEmpty()) {
